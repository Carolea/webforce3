...
if($_POST)
{
	$r = $bdd->query("SELECT * FROM membre WHERE pseudo ='$_POST[pseudo]'");
    
	if($r->rowCount() >= 1) //nombre de résultats de la requete select, si il y a au moins 1 resultat, un pseudo de la BDD correspond bien au pseudo du formulaire
	{
