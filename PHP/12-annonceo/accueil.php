...
$results_regions = $regions->fetchALL(PDO::FETCH_ASSOC);
...
<!--        <label for="select_region">Région</label>
        <select class="form-control" name="region" id="select_region">
        <option value="">Toutes les Régions</option>
        <?php foreach ($results_region as $key2 => $value2): ?>
          <option value="<?= $value2['id_region'] ?>"><?= $value2['titre'] ?></option>
        <?php endforeach; ?>
      </select>-->
    ...
    <div class="col-sm-12 col-md-8" id="annonces">
      ...
      <div class="panel panel-default">
        <a href="fiche_annonce.php?id_annonce=<?= $value['id_annonce'] ?>">
          <h4 class="text-center"><?= $value['titre'] ?></h4>
