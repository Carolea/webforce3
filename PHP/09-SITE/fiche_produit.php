...
if(isset($_GET['id_produit'])){
    ...
    $produit = $resultat->fetch(PDO::FETCH_ASSOC); //pas d'echo dans le traitement $contenu
    ...
    $contenu .= '<div class="col-md-4">
                    ...
                    <p class="lead">Prix: '. $produit['prix'] .' €</p>
                        ...
                        /*irl ajouter balise alt en bdd pour referencement*/
        ...
        if($produit['stock'] > 0){
            ...
            $contenu .= '<select name="quantite" class="form-group-sm form-control-static">';
                for($i = 1; $i <= $produit['stock'] && $i <= 5; $i++){
                    $contenu .= "<option>$i</option>"; //value par defaut $i
...
//EXERCICE : 
/*
- Crée des suggestions de produits : afficher 2 produits (photo et titre) aléatoirement appartenant à la catégorie du produit sélectionné par l'internaute.
- Ces 2 produits doivent être différents du produit affiché dans fiche produit.
- La photo est cliquable est renvoie à la fiche du produit.
